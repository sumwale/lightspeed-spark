...
import com.github.spark.lightspeed.memory.EvictionManager
 ...
 */
sealed class CacheValueStats(val weightage: Double, val generation: Int) {
...
final class CompressedCacheValueStats(
    ...
    extends CacheValueStats(weightage, generation) {
